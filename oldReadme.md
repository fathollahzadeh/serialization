**Overview:** In this experimental paper, we run a set of controlled experiments to analyze the impacts of different possible data models and their implementations. Our experiments are the same data wrangling tasks as it happens deep inside many Big Data systems. We investigate the impacts of host programming languages including different memory management methods, meta object-oriented models, system-specific formats and general purpose self-described documents.

The implementation has been compiled, built, and tested on Ubuntu 20.04 LTS. Make sure the following requirements are met in order for the system to function properly.
* [Install Dependencies](#install_dependencies)
* [Install Experiment](#install_experiment)
* [Dataset](#dataset)
* [Run Local Experiments](#local_experiment)
* [Run Distributed Experiment](#distributed_experiment)
* [Results](#results)
