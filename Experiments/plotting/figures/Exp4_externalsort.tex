...
\newcommand\resetstackedplots{
	...
	\makeatother
	\addplot [forget plot,draw=none] coordinates{({HandcodedCPP},0.1) ({inPlaceCPP},0.1) ({FlatBufCPP},0.1) ({ProtoBufCPP},0.1) ({BoostBinaryCPP},0.1) ({BoostCPP},0.1)  ({BsonCPP},0.1) 
	({BincodeRust},0.1) ({MessagePackRust},0.1) ({JsonRust},0.1) ({FlexBufRust},0.1) ({BsonRust},0.1) ({FlatBufJava},0.1) ({ProtoBufJava},0.1) ({KryoJava},0.1) ({ByteBufferJava},0.1) ({BsonJava},0.1) ({DefaultJava},0.1) ({JsonJava},0.1) ({Json+GzipJava},0.1)};
}
\makeatother
...
\begin{tikzpicture}
   ...
   \newcommand{\myaddplotnan}[9]{
	   ...
	   every node near coord/.append style={		  
		   check for zeronan/.code={
			   ...
			   \showvalue{\xbaseline}{}{}{}{FlatBufJava}{}{BincodeRust}{}{}{}
  ...
  \pgfplotsset{
   ...
   \begin{groupplot}[
		...
		ytick align=inside,
		xtick align=outside,	
		ytick={2,5,10,20,50,100,270},
		yticklabels={2,5,10,20,50,100,270},		
		xtick pos=left,
		ytick pos=left,
		...
		width=\textwidth,  
		symbolic x coords={ HandcodedCPP, inPlaceCPP, FlatBufCPP, ProtoBufCPP, BoostBinaryCPP, BoostCPP, BsonCPP,BincodeRust, MessagePackRust,  JsonRust, FlexBufRust, BsonRust, FlatBufJava, ProtoBufJava, KryoJava, ByteBufferJava, BsonJava, DefaultJava, JsonJava, Json+GzipJava },
		xticklabels={HandCoded, , FlatBuf, , BoostBinary, , BSON,Bincode, ,JSON, , BSON, , ProtoBuf, , ByteBuffer, , Default, , JSON+Gzip},  
		extra x ticks={inPlaceCPP,ProtoBufCPP,BoostCPP,MessagePackRust,FlexBufRust,FlatBufJava,KryoJava,BsonJava,JsonJava},
		extra x tick labels={InPlace,ProtoBuf,BoostText,MessagePack,FlexBuf,FlatBuf,Kryo,BSON,JSON},
...
\addDiagramExpOne{CPP}{colora}{color7}{0.48\textwidth}{{2,5,10,20,50,100,270}}{1}{{enlarge x limits=0.12,}}{left}{C++};		

\node [draw=none,inner sep=0, font=\scriptsize, anchor=west](leg1) at (rel axis cs: 0.04,0.77) {\shortstack[l]{
...
\addDiagramExpOne{Rust}{colora}{color7}{0.40\textwidth}{\empty}{0}{{enlarge x limits=0.24,}}{left}{Rust};
\addDiagramExpOne{Java}{colora}{color7}{0.54\textwidth}{\empty}{1}{{enlarge x limits=0.12,}}{right}{Java};
		
\end{groupplot}

\begin{scope}[decoration=brace]
	\pgfdecorationsegmentamplitude=5pt
	\draw[decorate] ($(T2.south east)+(20pt,0)$) -- ($(T0.south west)+(-30pt,0)$) node[midway,below=\pgfdecorationsegmentamplitude] {\footnotesize{C++}};
	\draw[decorate] ($(T4.south east)+(20pt,0)$) -- ($(T3.south west)+(-15pt,0)$) node[midway,below=\pgfdecorationsegmentamplitude] {\footnotesize{Rust}};
	\draw[decorate] ($(T8.south east)+(30pt,0)$) -- ($(T5.south west)+(0pt,0)$) node[midway,below=\pgfdecorationsegmentamplitude] {\footnotesize{Java}};	
  \end{scope}
\end{tikzpicture}