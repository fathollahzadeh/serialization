   ...
   \newcommand{\myaddplotnan}[8]{
	   ...
	   every node near coord/.append style={		  
		   check for zeronan/.code={
			   ...
			   \showvalue{\xbaseline}{BincodeRust}{BsonRust}{BsonJava}{DefaultJava}{}{FlatBufJava}{ByteBufferJava}{}{}
...
\addDiagramExpOne{Rust}{black}{color7}{0.21\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.18,}};
...
\addDiagramExpOne{Java}{black}{color7}{0.29\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.10,}};
