...
\begin{tikzpicture}
	\newcommand{\myaddplot}[7]{
	   ...
	   table[ y=time, col sep=comma, x=baseline] {results/Exp1_write_parallel.dat};
	   \label{#3#7}
   };  
   ...
   \newcommand{\myaddplotnan}[8]{
	   ...
	   every node near coord/.append style={		  
		   check for zeronan/.code={
			   ...
			   \showvalue{\xbaseline}{HandcodedCPP}{inPlaceCPP}{FlatBufCPP}{ProtoBufCPP}{}{MessagePackRust}{JsonRust}{FlexBufRust}{BsonRust};
			   \showvalue{\xbaseline}{BincodeRust}{BsonRust}{BsonJava}{DefaultJava}{}{FlatBufJava}{ByteBufferJava}{BoostBinaryCPP}{}
   ...
   \newcommand{\addDiagramExpOne}[7]{	
	\nextgroupplot[
		...
		\myaddplot{0}{#2}{IO}{black}{none}{I/O Time(taskset True)}{#1};
  		\myaddplotnan{0}{colorb}{CPU}{black}{north east lines}{CPU Time(taskset True)}{#1}{black};
...
\addDiagramExpOne{CPP}{colora}{white}{0.27\textwidth}{{10,100,1000}}{{10,100,1000}}{{enlarge x limits=0.15,}};	
...
\addDiagramExpOne{Rust}{colora}{color7}{0.215\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.18,}};
...
\addDiagramExpOne{Java}{colora}{color7}{0.29\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.10,}};
