   ...
   \newcommand{\addDiagramExpOne}[7]{	
	\nextgroupplot[
		...
		\myaddplot{0}{#2}{IO}{black}{none}{I/O Time(taskset True)}{#1};
  		\myaddplotnan{0}{colord}{CPU}{black}{north east lines}{CPU Time(taskset True)}{#1}{black};
...
\addDiagramExpOne{CPP}{colora}{white}{0.35\textwidth}{{10,100,1000}}{{10,100,1000}}{{enlarge x limits=0.15,}};	
...
\addDiagramExpOne{Rust}{colora}{color7}{0.285\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.18,}};
...
\addDiagramExpOne{Java}{colora}{color7}{0.37\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.10,}};
