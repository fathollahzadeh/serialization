   ...
   \newcommand{\addDiagramExpOne}[7]{	
	\nextgroupplot[
		...
		\myaddplot{0}{#2}{IO}{black}{none}{I/O Time(taskset True)}{#1};
  		\myaddplotnan{0}{tugb}{CPU}{black}{north east lines}{CPU Time(taskset True)}{#1}{black};
...
\addDiagramExpOne{CPP}{tug}{white}{0.27\textwidth}{{10,100,1000}}{{10,100,1000}}{{enlarge x limits=0.15,}};	
...
\addDiagramExpOne{Rust}{tug}{color7}{0.215\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.18,}};
...
\addDiagramExpOne{Java}{tug}{color7}{0.29\textwidth}{}{{10,100,1000}}{{enlarge x limits=0.10,}};
