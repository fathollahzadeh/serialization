...
\node [draw=none,inner sep=0, font=\scriptsize, anchor=west](leg1) at (rel axis cs: 0.1,0.81) {\shortstack[l]{
...
\begin{scope}[decoration=brace]
	...
	\draw[decorate] ($(T4.south east)+(55pt,0)$) -- ($(T3.south west)+(5pt,0)$) node[midway,below=\pgfdecorationsegmentamplitude] {\scriptsize{Rust}};
