...
export jCMD="java -Xms30g -Xmx30g -Xmn6g --illegal-access=deny -Dlog4j.configuration=file:$LOG4JPROP"
export jnCMD="java -Xms30g -Xmx30g -Xmn6g --illegal-access=deny -Dlog4j.configuration=file:$LOG4JPROP"
