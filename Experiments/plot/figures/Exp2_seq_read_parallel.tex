   ...
   \newcommand{\myaddplotnan}[8]{
	   ...
	   every node near coord/.append style={		  
		   check for zeronan/.code={
			   ...
			   \showvalue{\xbaseline}{BsonRust}{inPlaceCPP}{FlatBufCPP}{JsonJava}{BsonJava}{DefaultJava}{ProtoBufJava}{ByteBufferJava}{FlatBufJava};
			   \showvalue{\xbaseline}{KryoJava}{JsonRust}{FlexBufRust}{}{}{}{}{}{}
...
\addDiagramExpOne{CPP}{tug}{color7}{0.21\textwidth}{{10,100}}{{10,100}}{{enlarge x limits=0.15,}};	
...
\node [draw=none,inner sep=0, font=\scriptsize, anchor=west](leg1) at (rel axis cs: 0.1,0.86) {\shortstack[l]{
		\ref{CPUCPP} CPU 
		\ref{IOCPP} IO 
}};
