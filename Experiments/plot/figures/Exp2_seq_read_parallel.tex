...
\begin{tikzpicture}
	\newcommand{\myaddplot}[7]{
	   ...
	   table[ y=time, col sep=comma, x=baseline] {results/Exp2_read_parallel.dat};
	   \label{#3#7}
   };  
   ...
   \newcommand{\myaddplotnan}[8]{
	   ...
	   every node near coord/.append style={		  
		   check for zeronan/.code={
			   ...
			   \showvalue{\xbaseline}{BsonRust}{inPlaceCPP}{FlatBufCPP}{FlexBufRust}{KryoJava}{JsonRust}{ProtoBufJava}{}{FlatBufJava};
