   ...
   \newcommand{\myaddplotnan}[8]{
	   ...
	   every node near coord/.append style={		  
		   check for zeronan/.code={
			   ...
			   \showvalue{\xbaseline}{}{inPlaceCPP}{FlatBufCPP}{FlexBufRust}{KryoJava}{JsonRust}{ProtoBufJava}{FlatBufJava}{};
...
\addDiagramExpOne{CPP}{black}{white}{0.26\textwidth}{{1,2,3,5,10}}{{1,2,3,5,10}}{{enlarge x limits=0.15,}};	
