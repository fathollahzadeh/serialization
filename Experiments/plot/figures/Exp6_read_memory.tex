...
\begin{tikzpicture}
   ...
   \begin{groupplot}[
		...
		ByteBufferJava,KryoJava,ProtoBufJava,FlatBufJava,DefaultJava,BsonJava,JsonJava, Json+GzipJava},		   
		xticklabels={InPlace,FlatBuf,HandCoded,BoostBinary,BoostText,ProtoBuf,Bson, Bincode, FlexBuf,MessagePack,Bson, Json, ByteBuffer,Kryo,ProtoBuf,FlatBuf,Default,Bson,Json, Json+Gzip},		
		point meta=rawy,            
		nodes near coords={%
...
\addDiagramExpOne{CPP}{0.26\textwidth}{{enlarge x limits=0.15,}}{{0,16,32,48,64,80,96,112,128}}{{0,16,32,48,64,80,96,112,128}};	
...
\addDiagramExpOne{Rust}{0.21\textwidth}{{enlarge x limits=0.18,}}{{0,16,32,48,64,80,96,112,128}}{{}};
...
\addDiagramExpOne{Java}{0.29\textwidth}{{enlarge x limits=0.10,}}{{0,16,32,48,64,80,96,112,128}}{{}};
