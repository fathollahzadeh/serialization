...
\addDiagramExpOne{CPP}{tugb}{color7}{0.40\textwidth}{{10,100,1000,10000,100000}}{1}{{enlarge x limits=0.12,}}{left}{C++};		
...
\addDiagramExpOne{Rust}{tugb}{color7}{0.38\textwidth}{\empty}{0}{{enlarge x limits=0.24,}}{left}{Rust};
\node [draw=none,inner sep=0, font=\scriptsize, anchor=west](leg1) at (rel axis cs: 0.04,0.85) {\shortstack[l]{
		\ref{CPUFalse} CPU Time(taskset False) \\ \\
		\ref{IOFalse} I/O Time(taskset False) 			
}};
\addDiagramExpOne{Java}{tugb}{color7}{0.50\textwidth}{\empty}{1}{{enlarge x limits=0.12,}}{right}{Java};
