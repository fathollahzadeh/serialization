...
\newcommand\resetstackedplots{
	...
	({BincodeRust},0.1) ({MessagePackRust},0.1) ({JsonRust},0.1) ({FlexBufRust},0.1) ({BsonRust},0.1) ({Json+GzipJava},0.1) ({JsonJava},0.1) ({BsonJava},0.1) ({DefaultJava},0.1) ({ProtoBufJava},0.1) ({ByteBufferJava},0.1) ({FlatBufJava},0.1) ({KryoJava},0.1)};
}
\makeatother
...
\begin{tikzpicture}
  ...
  \pgfplotsset{
   ...
   \begin{groupplot}[
		...
		symbolic x coords={ HandcodedCPP, inPlaceCPP, FlatBufCPP, ProtoBufCPP, BoostBinaryCPP, BoostCPP, BsonCPP,BincodeRust, MessagePackRust,  JsonRust, FlexBufRust, BsonRust, Json+GzipJava, JsonJava, BsonJava, DefaultJava, ProtoBufJava, ByteBufferJava, FlatBufJava, KryoJava},
		%%%%%%%%%%%		   
		xticklabels={HandcodedCPP, , FlatBufCPP, , BoostBinaryCPP, , BsonCPP, , MessagePackRust , , FlexBufRust, , Json+GzipJava, , BsonJava, , ProtoBufJava, , FlatBufJava, },  
		extra x ticks={inPlaceCPP,ProtoBufCPP,BoostCPP,BincodeRust,JsonJava,DefaultJava,ByteBufferJava,KryoJava},
		extra x tick labels={inPlaceCPP,ProtoBufCPP,BoostCPP,BincodeRust,JsonJava,DefaultJava,ByteBufferJava,KryoJava},
		%%%%%%%%%%%
