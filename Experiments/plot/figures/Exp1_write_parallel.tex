...
\addDiagramExpOne{Java}{black}{color7}{0.28\textwidth}{}{}{{enlarge x limits=0.10,}};
...
\node [draw=none,inner sep=0, font=\scriptsize, anchor=west](leg1) at ($(group c2r1.north west) + (-0.0cm,0.3cm)$) {\shortstack[l]{
		\ref{CPUJava} CPU \ \ \  
		\ref{IOJava} I/O
}};
