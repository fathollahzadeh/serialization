...
#declare -a cpp_methods=("Handcoded")
...
echo "baseline,language,taskset,execution,platform,seq_rand,nrow,time" >>results/Experiment3_ExternalSort_Write_times.dat
echo "baseline,language,taskset,execution,platform,seq_rand,nrow,time" >>results/Experiment3_ExternalSort_Read_times.dat
echo "baseline,language,taskset,chunk_size,nrow,time" >>results/Experiment3_ExternalSort_times.dat
...
for method in "${cpp_methods[@]}"; do
    ...
    ./explocal/runExperiment1c_WriteCPP.sh $method $inDataPathCPP $outDataPath $externalsort_nrow Single false Experiment3_ExternalSort_Write_times
    ./explocal/runExperiment2a_ReadIOCPP.sh $method $outDataPath $nrow Single false Sequential Experiment3_ExternalSort_Read_times
    ...
    #./explocal/runExperiment3_ExternalSortCPP.sh $method $outDataPath $outExternalSort $nrow false Experiment3_ExternalSort_times
done
