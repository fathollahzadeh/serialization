...
drawPlot <- function(data,isseq,ts,hasshleg){
  ...
  text(3, 6, xlb, cex=1.4)
  if(ts=="true"){
    title(ylab="Total Random Read Time (sec) - log", col.lab="black",family="Helvetica",cex.lab = 1.4,line = 2.7,font=2,las=1)
  }
...
pdf(file='Experiment_Rand_Read_CPU_Plot.pdf',height=8, width=10)
