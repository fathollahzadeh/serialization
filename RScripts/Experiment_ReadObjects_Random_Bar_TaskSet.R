...
text(x=p, y=totaltime+totaltime*0.05, font = 2, font.lab = 2, labels=round(totaltime, 1), pos=3, xpd=NA, cex=0.7,srt=90)

text(x=p[c(-1,-2,-3,-4)]+0.2, y=totaltime[c(-1,-2,-3,-4)]-totaltime[c(-1,-2,-3,-4)]*0.115, font = 1, font.lab = 2, labels=round(cputime[c(-1,-2,-3,-4)], 1), pos=3, xpd=NA, cex=0.6,srt=90)
#text(x=p[24]+0.2, y=totaltime[24]-totaltime[24]*0.16, font = 1, font.lab = 2, labels=round(cputime[24], 1), pos=3, xpd=NA, cex=0.45,srt=90)
...
text(x=(p1+p2)/2-2,  y=min_y-min_y/4, xnamestasksettrue, xpd=NA, srt=45, pos=3, font=1, cex=0.7)
