...
z <-c(min_y,z[c(-2,-3,-5,-8,-9,-10,-12,-14,-15,-20)],max_y)
...
text(x=p[c(-1,-2,-3,-4)]+0.2, y=totaltime[c(-1,-2,-3,-4)]-totaltime[c(-1,-2,-3,-4)]*0.18, font = 1, font.lab = 2, labels=round(cputime[c(-1,-2,-3,-4)], 1), pos=3, xpd=NA, cex=0.6,srt=90)
