...
public final class DoubleList1 extends Table {
  ...
  public edu.bu.tweet.flatbuffers.DoubleList2 values(int j) { return values(new edu.bu.tweet.flatbuffers.DoubleList2(), j); }
  public edu.bu.tweet.flatbuffers.DoubleList2 values(edu.bu.tweet.flatbuffers.DoubleList2 obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int valuesLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public edu.bu.tweet.flatbuffers.DoubleList2.Vector valuesVector() { return valuesVector(new edu.bu.tweet.flatbuffers.DoubleList2.Vector()); }
  public edu.bu.tweet.flatbuffers.DoubleList2.Vector valuesVector(edu.bu.tweet.flatbuffers.DoubleList2.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
