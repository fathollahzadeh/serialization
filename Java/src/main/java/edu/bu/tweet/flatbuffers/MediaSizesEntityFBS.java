...
public final class MediaSizesEntityFBS extends Table {
  ...
  public edu.bu.tweet.flatbuffers.SizeEntityFBS thumb() { return thumb(new edu.bu.tweet.flatbuffers.SizeEntityFBS()); }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS thumb(edu.bu.tweet.flatbuffers.SizeEntityFBS obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS large() { return large(new edu.bu.tweet.flatbuffers.SizeEntityFBS()); }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS large(edu.bu.tweet.flatbuffers.SizeEntityFBS obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS medium() { return medium(new edu.bu.tweet.flatbuffers.SizeEntityFBS()); }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS medium(edu.bu.tweet.flatbuffers.SizeEntityFBS obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS small() { return small(new edu.bu.tweet.flatbuffers.SizeEntityFBS()); }
  public edu.bu.tweet.flatbuffers.SizeEntityFBS small(edu.bu.tweet.flatbuffers.SizeEntityFBS obj) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
