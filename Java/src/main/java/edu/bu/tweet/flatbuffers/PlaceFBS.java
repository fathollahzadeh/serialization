...
public final class PlaceFBS extends Table {
  ...
  public edu.bu.tweet.flatbuffers.BoundingBoxCoordinateFBS boundingBox() { return boundingBox(new edu.bu.tweet.flatbuffers.BoundingBoxCoordinateFBS()); }
  public edu.bu.tweet.flatbuffers.BoundingBoxCoordinateFBS boundingBox(edu.bu.tweet.flatbuffers.BoundingBoxCoordinateFBS obj) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
