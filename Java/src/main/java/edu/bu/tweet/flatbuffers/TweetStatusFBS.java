...
public final class TweetStatusFBS extends Table {
  ...
  public edu.bu.tweet.flatbuffers.UserFBS user() { return user(new edu.bu.tweet.flatbuffers.UserFBS()); }
  public edu.bu.tweet.flatbuffers.UserFBS user(edu.bu.tweet.flatbuffers.UserFBS obj) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.CoordinatesFBS coordinates() { return coordinates(new edu.bu.tweet.flatbuffers.CoordinatesFBS()); }
  public edu.bu.tweet.flatbuffers.CoordinatesFBS coordinates(edu.bu.tweet.flatbuffers.CoordinatesFBS obj) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.PlaceFBS place() { return place(new edu.bu.tweet.flatbuffers.PlaceFBS()); }
  public edu.bu.tweet.flatbuffers.PlaceFBS place(edu.bu.tweet.flatbuffers.PlaceFBS obj) { int o = __offset(24); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public edu.bu.tweet.flatbuffers.TweetStatusFBS quotedStatus() { return quotedStatus(new edu.bu.tweet.flatbuffers.TweetStatusFBS()); }
  public edu.bu.tweet.flatbuffers.TweetStatusFBS quotedStatus(edu.bu.tweet.flatbuffers.TweetStatusFBS obj) { int o = __offset(30); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.TweetStatusFBS retweetedStatus() { return retweetedStatus(new edu.bu.tweet.flatbuffers.TweetStatusFBS()); }
  public edu.bu.tweet.flatbuffers.TweetStatusFBS retweetedStatus(edu.bu.tweet.flatbuffers.TweetStatusFBS obj) { int o = __offset(32); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public edu.bu.tweet.flatbuffers.EntitiesFBS entities() { return entities(new edu.bu.tweet.flatbuffers.EntitiesFBS()); }
  public edu.bu.tweet.flatbuffers.EntitiesFBS entities(edu.bu.tweet.flatbuffers.EntitiesFBS obj) { int o = __offset(42); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public edu.bu.tweet.flatbuffers.ExtendedEntitiesFBS extendedEntities() { return extendedEntities(new edu.bu.tweet.flatbuffers.ExtendedEntitiesFBS()); }
  public edu.bu.tweet.flatbuffers.ExtendedEntitiesFBS extendedEntities(edu.bu.tweet.flatbuffers.ExtendedEntitiesFBS obj) { int o = __offset(44); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS matchingRules(int j) { return matchingRules(new edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS(), j); }
  public edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS matchingRules(edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS obj, int j) { int o = __offset(56); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int matchingRulesLength() { int o = __offset(56); return o != 0 ? __vector_len(o) : 0; }
  public edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS.Vector matchingRulesVector() { return matchingRulesVector(new edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS.Vector()); }
  public edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS.Vector matchingRulesVector(edu.bu.tweet.flatbuffers.MatchingRulesEntityFBS.Vector obj) { int o = __offset(56); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public edu.bu.tweet.flatbuffers.MapStringBool scopes(int j) { return scopes(new edu.bu.tweet.flatbuffers.MapStringBool(), j); }
  public edu.bu.tweet.flatbuffers.MapStringBool scopes(edu.bu.tweet.flatbuffers.MapStringBool obj, int j) { int o = __offset(60); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int scopesLength() { int o = __offset(60); return o != 0 ? __vector_len(o) : 0; }
  public edu.bu.tweet.flatbuffers.MapStringBool.Vector scopesVector() { return scopesVector(new edu.bu.tweet.flatbuffers.MapStringBool.Vector()); }
  public edu.bu.tweet.flatbuffers.MapStringBool.Vector scopesVector(edu.bu.tweet.flatbuffers.MapStringBool.Vector obj) { int o = __offset(60); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
