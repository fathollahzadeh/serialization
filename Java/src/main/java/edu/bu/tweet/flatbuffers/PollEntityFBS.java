...
public final class PollEntityFBS extends Table {
  ...
  public edu.bu.tweet.flatbuffers.OptionEntityFBS options(int j) { return options(new edu.bu.tweet.flatbuffers.OptionEntityFBS(), j); }
  public edu.bu.tweet.flatbuffers.OptionEntityFBS options(edu.bu.tweet.flatbuffers.OptionEntityFBS obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int optionsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public edu.bu.tweet.flatbuffers.OptionEntityFBS.Vector optionsVector() { return optionsVector(new edu.bu.tweet.flatbuffers.OptionEntityFBS.Vector()); }
  public edu.bu.tweet.flatbuffers.OptionEntityFBS.Vector optionsVector(edu.bu.tweet.flatbuffers.OptionEntityFBS.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
