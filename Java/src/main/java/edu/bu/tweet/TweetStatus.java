...
//		properties.put(JsonGenerator.PRETTY_PRINTING, true);
    ...
    private TweetStatus readJSONTweetStatus(JsonObject jsonObject) {
        ...
        if (jsonObject.get("in_reply_to_screen_name") != null && jsonObject.get("in_reply_to_screen_name") != JsonValue.NULL) {
        ...
        if (jsonObject.getJsonObject("coordinates") != null && jsonObject.getJsonObject("coordinates") != JsonValue.NULL) {
        ...
        if (jsonObject.getJsonObject("quoted_status") != null && jsonObject.getJsonObject("quoted_status") != JsonValue.NULL) {
        ...
        if (jsonObject.getJsonObject("retweeted_status") != null && jsonObject.getJsonObject("retweeted_status") != JsonValue.NULL) {
    ...
    public TweetStatusProtos.TweetStatusP protoObjectBuilder() {
        ...
        if (this.place != null) {
            ...
            if (this.getPlace().getBounding_box() != null) {
                TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.Builder boundingBoxCoordinateP = TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.newBuilder();
                ...
                for (int i = 0; i < this.getPlace().getBounding_box().getCoordinates().size(); ++i) {
                    TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.RowsOneP.Builder rowsOneP = TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.RowsOneP.newBuilder();

                    for (int j = 0; j < this.getPlace().getBounding_box().getCoordinates().get(i).size(); ++j) {
                        TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.RowsOneP.RowsTwoP.Builder rowsTwoP = TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.RowsOneP.RowsTwoP.newBuilder();

                        for (int k = 0; k < this.getPlace().getBounding_box().getCoordinates().get(i).get(j).size(); ++k) {
                            rowsTwoP.addCoordinate(this.getPlace().getBounding_box().getCoordinates().get(i).get(j).get(k));
                        }
        ...
        if (this.entities != null) {
            ...
            TweetStatusProtos.TweetStatusP.EntitiesP.Builder entitiesP = TweetStatusProtos.TweetStatusP.EntitiesP.newBuilder();
            ...
            for (UserMentionEntity userMentionEntity : this.entities.getUser_mentions()) {
                TweetStatusProtos.UserMentionEntityP.Builder userMentionEntityP = TweetStatusProtos.UserMentionEntityP.newBuilder();
            ...
            for (PollEntity pollEntity : this.entities.getPolls()) {
                ...
                for (OptionEntity optionEntity : pollEntity.getOptions()) {
                    TweetStatusProtos.OptionEntityP.Builder optionEntityP = TweetStatusProtos.OptionEntityP.newBuilder();
        ...
        if (this.getExtended_entities() != null) {
            ...
            TweetStatusProtos.TweetStatusP.ExtendedEntitiesP.Builder extendedEntitiesP = TweetStatusProtos.TweetStatusP.ExtendedEntitiesP.newBuilder();
        ...
        for (MatchingRulesEntity matchingRulesEntity : this.matching_rules) {
            TweetStatusProtos.MatchingRulesEntityP.Builder matchingRulesEntityP = TweetStatusProtos.MatchingRulesEntityP.newBuilder();
    ...
    void setMediaEntityP(TweetStatusProtos.MediaEntityP.Builder mediaEntityP, MediaEntity mediaEntity) {
        ...
        if (mediaEntity.getSizes() != null) {
            TweetStatusProtos.MediaSizesEntityP.Builder mediaSizesEntityP = TweetStatusProtos.MediaSizesEntityP.newBuilder();
        ...
        if (mediaEntity.getAdditional_media_info() != null) {
            TweetStatusProtos.AdditionalMediaInfoEntityP.Builder additionalMediaInfoEntityP = TweetStatusProtos.AdditionalMediaInfoEntityP.newBuilder();
    ...
    public TweetStatus tweetObjectBuilder(TweetStatusProtos.TweetStatusP protoTweet) {
        ...
        if (this.place != null) {
            ...
            if (placeP.getBoundingBoxCoordinateP() != null) {
                ...
                TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP boundingBoxCoordinateP = placeP.getBoundingBoxCoordinateP();
                if (boundingBoxCoordinateP.getType() != null)
                    this.place.getBounding_box().setType(boundingBoxCoordinateP.getType());

                List<List<List<Double>>> coordinates = new ArrayList<>();
                for (TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.RowsOneP rowsOneP : boundingBoxCoordinateP.getThreeDimArrayList()) {

                    List<List<Double>> list2 = new ArrayList<>();
                    for (TweetStatusProtos.TweetStatusP.PlaceP.BoundingBoxCoordinateP.RowsOneP.RowsTwoP rowsTwoP : rowsOneP.getRowsTwoPList()) {
        ...
        if (protoTweet.getEntitiesP() != null) {
            ...
            //UserMentionEntity
            for (TweetStatusProtos.UserMentionEntityP userMentionEntityP : protoTweet.getEntitiesP().getUserMentionEntityPList()) {
    ...
    private MediaEntity getMediaEntity(TweetStatusProtos.MediaEntityP mediaEntityP) {
        ...
        if (mediaEntityP.getAdditionalMediaInfo() != null) {
            ...
            TweetStatusProtos.AdditionalMediaInfoEntityP additionalMediaInfoEntityP = mediaEntityP.getAdditionalMediaInfo();
    ...
    public byte[] writeByteBuffer() {
        ...
        byte[] in_reply_to_screen_nameBytes = (in_reply_to_screen_name != null)
                ? in_reply_to_screen_name.getBytes(Charset.forName("UTF-8"))
                : new byte[0];
