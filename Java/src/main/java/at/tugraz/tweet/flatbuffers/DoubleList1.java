...
public final class DoubleList1 extends Table {
  ...
  public at.tugraz.tweet.flatbuffers.DoubleList2 values(int j) { return values(new at.tugraz.tweet.flatbuffers.DoubleList2(), j); }
  public at.tugraz.tweet.flatbuffers.DoubleList2 values(at.tugraz.tweet.flatbuffers.DoubleList2 obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int valuesLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public at.tugraz.tweet.flatbuffers.DoubleList2.Vector valuesVector() { return valuesVector(new at.tugraz.tweet.flatbuffers.DoubleList2.Vector()); }
  public at.tugraz.tweet.flatbuffers.DoubleList2.Vector valuesVector(at.tugraz.tweet.flatbuffers.DoubleList2.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
