...
public class ExternalSort_leak {
    ...
    public static void main(String[] args) {
        ...
        ///mnt/javadata//serialization_5.se 5 5 1
        ExternalSort_leak externalSort=new ExternalSort_leak();
        externalSort.fileName="/mnt/javadata//serialization_5.se";//args[0];
        externalSort.numberOfFiles=5;//Integer.parseInt(args[1]);
        externalSort.serializationType=5;//Integer.parseInt(args[2]);
        int round= 1;//Integer.parseInt(args[3]);
