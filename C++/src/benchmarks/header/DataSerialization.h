...
public:
    ...
    DataSerialization(string inputFileName, string outFileName, int serializationType, long numberOfTweets,int round,bool taskset);
...
template<class T>
DataSerialization<T>::DataSerialization(string inputFileName, string outFileName, int serializationType,long numberOfTweets,int round,bool taskset) {
    this->inputFileName=inputFileName;
    this->outFileName = outFileName;
    this->serializationType = serializationType;
    this->numberOfTweets = numberOfTweets;
    this->taskset=taskset;
    this->logFileHandler = new LogFileHandler("bin/benchmark/writeobjects/result_cpp_writeobjects_" + to_string(numberOfTweets) + "_" + to_string(round) +".txt");
}
