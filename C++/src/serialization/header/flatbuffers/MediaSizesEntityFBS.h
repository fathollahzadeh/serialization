...
inline MediaSizesEntityFBST *MediaSizesEntityFBS::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::MediaSizesEntityFBST> _o = std::unique_ptr<tweetstatusflatbuffers::MediaSizesEntityFBST>(new MediaSizesEntityFBST());
