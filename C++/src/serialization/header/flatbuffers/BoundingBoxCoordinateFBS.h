...
inline BoundingBoxCoordinateFBST *BoundingBoxCoordinateFBS::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::BoundingBoxCoordinateFBST> _o = std::unique_ptr<tweetstatusflatbuffers::BoundingBoxCoordinateFBST>(new BoundingBoxCoordinateFBST());
...
inline DoubleList1T *DoubleList1::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::DoubleList1T> _o = std::unique_ptr<tweetstatusflatbuffers::DoubleList1T>(new DoubleList1T());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline DoubleList2T *DoubleList2::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::DoubleList2T> _o = std::unique_ptr<tweetstatusflatbuffers::DoubleList2T>(new DoubleList2T());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
