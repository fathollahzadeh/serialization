...
inline ExtendedEntitiesFBST *ExtendedEntitiesFBS::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::ExtendedEntitiesFBST> _o = std::unique_ptr<tweetstatusflatbuffers::ExtendedEntitiesFBST>(new ExtendedEntitiesFBST());
