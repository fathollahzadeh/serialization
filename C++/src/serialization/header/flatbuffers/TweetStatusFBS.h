...
inline MapStringBoolT *MapStringBool::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::MapStringBoolT> _o = std::unique_ptr<tweetstatusflatbuffers::MapStringBoolT>(new MapStringBoolT());
...
inline TweetStatusFBST *TweetStatusFBS::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::TweetStatusFBST> _o = std::unique_ptr<tweetstatusflatbuffers::TweetStatusFBST>(new TweetStatusFBST());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
