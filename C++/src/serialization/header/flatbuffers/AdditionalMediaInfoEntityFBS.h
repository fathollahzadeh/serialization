...
inline AdditionalMediaInfoEntityFBST *AdditionalMediaInfoEntityFBS::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::AdditionalMediaInfoEntityFBST> _o = std::unique_ptr<tweetstatusflatbuffers::AdditionalMediaInfoEntityFBST>(new AdditionalMediaInfoEntityFBST());
