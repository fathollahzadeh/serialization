...
inline UserMentionEntityFBST *UserMentionEntityFBS::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  std::unique_ptr<tweetstatusflatbuffers::UserMentionEntityFBST> _o = std::unique_ptr<tweetstatusflatbuffers::UserMentionEntityFBST>(new UserMentionEntityFBST());
