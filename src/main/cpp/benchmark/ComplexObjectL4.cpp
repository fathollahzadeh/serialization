...
#include "proto/ComplexObjectL4.pb.h"
#include <random>
#include <chrono>
...
static proto::ComplexObjectL415 *genComplexObjectL415() {
    ...
    cObject->set_var_string1(genRandomString(34));
    return cObject;
}
...
static proto::ComplexObjectL414 *genComplexObjectL414() {
    ...
    cObject->set_allocated_complexobjectl415(genComplexObjectL415());
    return cObject;
}
...
static proto::ComplexObjectL413 *genComplexObjectL413() {
    ...
    cObject->set_allocated_complexobjectl414(genComplexObjectL414());
...
static proto::ComplexObjectL412 *genComplexObjectL412() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl413(genComplexObjectL413());
    return cObject;
}
...
static proto::ComplexObjectL411 *genComplexObjectL411() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl412(genComplexObjectL412());
...
static proto::ComplexObjectL410 *genComplexObjectL410() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl411(genComplexObjectL411());
...
static proto::ComplexObjectL49 *genComplexObjectL49() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl410(genComplexObjectL410());
    return cObject;
}
...
static proto::ComplexObjectL48 *genComplexObjectL48() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl49(genComplexObjectL49());
...
static proto::ComplexObjectL47 *genComplexObjectL47() {
    ...
    cObject->set_allocated_complexobjectl48(genComplexObjectL48());
    return cObject;
}
...
static proto::ComplexObjectL46 *genComplexObjectL46() {
    ...
    cObject->set_allocated_complexobjectl47(genComplexObjectL47());
    return cObject;
}
...
static proto::ComplexObjectL45 *genComplexObjectL45() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl46(genComplexObjectL46());
    return cObject;
}
...
static proto::ComplexObjectL44 *genComplexObjectL44() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl45(genComplexObjectL45());
    return cObject;
}
...
static proto::ComplexObjectL43 *genComplexObjectL43() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl44(genComplexObjectL44());
    return cObject;
}
...
static proto::ComplexObjectL42 *genComplexObjectL42() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl43(genComplexObjectL43());
    return cObject;
}
...
static proto::ComplexObjectL41 *genComplexObjectL41() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl42(genComplexObjectL42());
    return cObject;
}
...
static proto::ComplexObjectL4 *genComplexObjectL4() {
    ...
    cObject->set_var_bool1(true);
    cObject->set_var_string1(genRandomString(31));
    cObject->set_allocated_complexobjectl41(genComplexObjectL41());
    return cObject;
}
...
int main(int argc, char *argv[]) {
    ...
    cout << "ComplexObjectL4 avg serialization=" << avg << "  avg deserialize=" << avgd<< "   buffer size="<<bufferSize << endl;
