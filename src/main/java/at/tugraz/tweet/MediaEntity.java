...
import at.tugraz.tweet.flatbuffers.MediaEntityFBS;
...
public class MediaEntity extends Base implements RootData {
	...
	public byte[] writeByteBuffer() {
		...
		byte[] source_status_id_strBytes = (source_status_id_str != null) ? source_status_id_str
			.getBytes() : new byte[0];
		...
		byte[] additional_media_infoBytes = (additional_media_info != null) ? additional_media_info
			.writeByteBuffer() : new byte[0];
	...
	public MediaEntity readJSONMediaEntity(JsonObject jsonObject) {
		...
		if(jsonObject.getJsonObject("additional_media_info") != null && jsonObject
			.getJsonObject("additional_media_info") != JsonValue.NULL) {
			JsonObject additional_media_infoJsonObject = jsonObject.getJsonObject("additional_media_info");
			this.additional_media_info = new AdditionalMediaInfoEntity()
				.readJSONAdditionalMediaInfoEntity(additional_media_infoJsonObject);
		}
	...
	public byte[] bsonSerialization() {
		...
		if(this.additional_media_info != null)
			writer.writeBinaryData("additional_media_info",
				new BsonBinary(this.additional_media_info.bsonSerialization()));
	...
	public int flatBuffersWriter(FlatBufferBuilder builder) {
		...
		int additional_media_infoBuilder = this.additional_media_info != null ? this.additional_media_info
