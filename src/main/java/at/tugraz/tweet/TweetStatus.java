...
public class TweetStatus extends Base implements RootData {
    ...
    public TweetStatusProtos.TweetStatusP protoObjectBuilder() {
        ...
        // set user:
        TweetStatusProtos.UserP.Builder userP = TweetStatusProtos.UserP.newBuilder();
        userP.setId(this.user.getId());
        userP.setIdStr(this.user.getId_str());
        ...
        for (URLEntity urlEntity : this.user.getDescriptionURLEntities()) {
            ...
            userP.setDescriptionURLEntities(urlEntityP);
        }
        ...
        if (this.coordinates != null && this.coordinates.getCoordinates().length > 0) {
            ...
            TweetStatusProtos.CoordinatesP.Builder coordinatesP = TweetStatusProtos.CoordinatesP
                    .newBuilder();
        ...
        // set place:
        if (this.place != null) {
            TweetStatusProtos.PlaceP.Builder placeP = TweetStatusProtos.PlaceP.newBuilder();
            ...
            if (this.getPlace().getBounding_box() != null) {
                TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.Builder boundingBoxCoordinateP = TweetStatusProtos.PlaceP.BoundingBoxCoordinateP
                        .newBuilder();
                ...
                for (int i = 0; i < this.getPlace().getBounding_box().getCoordinates().size(); ++i) {
                    TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.RowsOneP.Builder rowsOneP = TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.RowsOneP
                            .newBuilder();

                    for (int j = 0; j < this.getPlace().getBounding_box().getCoordinates().get(i).size(); ++j) {
                        TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.RowsOneP.RowsTwoP.Builder rowsTwoP = TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.RowsOneP.RowsTwoP
                                .newBuilder();
        ...
        if (this.entities != null) {
            tweetP.setEntitiesP(getEntityP(this.entities));
        }

        if (this.getExtended_tweet() != null) {
            TweetStatusProtos.ExtendedTweetEntityP.Builder extendedTweetP = TweetStatusProtos.ExtendedTweetEntityP.newBuilder();
            extendedTweetP.setFullText(this.extended_tweet.getFull_text());
            for (Integer integer : this.extended_tweet.getDisplay_text_range()) {
                extendedTweetP.addDisplayTextRange(integer);
            }
            if (this.extended_tweet.getEntities() != null) {
            ...
            if (this.extended_tweet.getExtendedEntities() != null) {
                ...
                extendedTweetP.setExtendedEntities(extendedEntitiesP);
            }
            tweetP.setExtendedTweet(extendedTweetP);
        }
    ...
    TweetStatusProtos.EntitiesP.Builder getEntityP(Entities entities) {
        TweetStatusProtos.EntitiesP.Builder entitiesP = TweetStatusProtos.EntitiesP.newBuilder();
        ...
        //UserMentionEntity
        for (UserMentionEntity userMentionEntity : entities.getUser_mentions()) {
        ...
        //SymbolEntity
        for (SymbolEntity symbolEntity : entities.getSymbols()) {
    ...
    public TweetStatus tweetObjectBuilder(TweetStatusProtos.TweetStatusP protoTweet) {
        ...
        this.id_str = protoTweet.getIdStr();
        ...
        // set user:
        this.user = new User();
        TweetStatusProtos.UserP userP = protoTweet.getUserP();
        this.user.setId(userP.getId());
        this.user.setId_str(userP.getIdStr());
        ...
        TweetStatusProtos.URLEntityP urlEntityP = userP.getDescriptionURLEntities();
        ...
        if (protoTweet.getCoordinates() != null) {
            ...
            TweetStatusProtos.CoordinatesP coordinatesP = protoTweet.getCoordinates();
        ...
        if (this.place != null) {
            ...
            if (placeP.getBoundingBoxCoordinateP() != null) {
                ...
                TweetStatusProtos.PlaceP.BoundingBoxCoordinateP boundingBoxCoordinateP = placeP.getBoundingBoxCoordinateP();
                if (boundingBoxCoordinateP.getType() != null)
                    this.place.getBounding_box().setType(boundingBoxCoordinateP.getType());

                List<List<List<Double>>> coordinates = new ArrayList<>();
                for (TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.RowsOneP rowsOneP : boundingBoxCoordinateP.getThreeDimArrayList()) {
                    List<List<Double>> list2 = new ArrayList<>();
                    for (TweetStatusProtos.PlaceP.BoundingBoxCoordinateP.RowsOneP.RowsTwoP rowsTwoP : rowsOneP.getRowsTwoPList()) {
    ...
    private Entities getEntities(TweetStatusProtos.EntitiesP entitiesP){
       Entities entities = new Entities();
        ...
        //URLEntity
        for (TweetStatusProtos.URLEntityP urlEntityP : entitiesP.getUrlEntityPList()) {
            URLEntity urlEntity = new URLEntity();
            if (urlEntityP.getDisplayURL() != null)
                urlEntity.setDisplay_url(urlEntityP.getDisplayURL());
            if (urlEntityP.getUrl() != null)
        ...
        //UserMentionEntity
        for (TweetStatusProtos.UserMentionEntityP userMentionEntityP : entitiesP.getUserMentionEntityPList()) {
        ...
        //SymbolEntity
        for (TweetStatusProtos.SymbolEntityP symbolEntityP : entitiesP.getSymbolEntityPList()) {
        ...
        //PollEntity
        for (TweetStatusProtos.PollEntityP pollEntityP : entitiesP.getPollEntityPList()) {
    ...
    private MediaEntity getMediaEntity(TweetStatusProtos.MediaEntityP mediaEntityP) {
        ...
        mediaEntity.setId_str(mediaEntity.getId_str());
