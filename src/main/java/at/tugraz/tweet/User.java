...
import at.tugraz.tweet.flatbuffers.UserFBS;
...
public class User extends Base implements RootData {
	...
	public byte[] writeByteBuffer() {
		...
		byte[] profile_background_colorBytes = (profile_background_color != null) ? profile_background_color
			.getBytes() : new byte[0];
		allocatedBufferSize += profile_background_colorBytes.length + 4;

		byte[] profile_background_image_urlBytes = (profile_background_image_url != null) ? profile_background_image_url
			.getBytes() : new byte[0];
		allocatedBufferSize += profile_background_image_urlBytes.length + 4;

		byte[] profile_background_image_url_httpsBytes = (profile_background_image_url_https != null) ? profile_background_image_url_https
			.getBytes() : new byte[0];
		...
		byte[] profile_sidebar_border_colorBytes = (profile_sidebar_border_color != null) ? profile_sidebar_border_color
			.getBytes() : new byte[0];
		allocatedBufferSize += profile_sidebar_border_colorBytes.length + 4;

		byte[] profile_sidebar_fill_colorBytes = (profile_sidebar_fill_color != null) ? profile_sidebar_fill_color
			.getBytes() : new byte[0];
	...
	public User readJSONUser(JsonObject jsonObject) {
		...
		if(jsonObject.get("profile_image_url_https") != null && jsonObject
			.get("profile_image_url_https") != JsonValue.NULL) {
		...
		if(jsonObject.get("profile_background_color") != null && jsonObject
			.get("profile_background_color") != JsonValue.NULL) {
			this.profile_background_color = jsonObject.getString("profile_background_color");
		}

		if(jsonObject.get("profile_background_image_url") != null && jsonObject
			.get("profile_background_image_url") != JsonValue.NULL) {
			this.profile_background_image_url = jsonObject.getString("profile_background_image_url");
		}

		if(jsonObject.get("profile_background_image_url_https") != null && jsonObject
			.get("profile_background_image_url_https") != JsonValue.NULL) {
		...
		if(jsonObject.get("profile_sidebar_border_color") != null && jsonObject
			.get("profile_sidebar_border_color") != JsonValue.NULL) {
			this.profile_sidebar_border_color = jsonObject.getString("profile_sidebar_border_color");
		}
		if(jsonObject.get("profile_sidebar_fill_color") != null && jsonObject
			.get("profile_sidebar_fill_color") != JsonValue.NULL) {
	...
	public int flatBuffersWriter(FlatBufferBuilder builder) {
		...
		int profile_banner_urlBuilder = this.profile_banner_url != null ? builder
			.createString(this.profile_banner_url) : 0;
		int profile_image_url_httpsBuilder = this.profile_image_url_https != null ? builder
			.createString(this.profile_image_url_https) : 0;
		...
		int profile_background_colorBuilder = this.profile_background_color != null ? builder
			.createString(this.profile_background_color) : 0;
		int profile_background_image_urlBuilder = this.profile_background_image_url != null ? builder
			.createString(this.profile_background_image_url) : 0;
		int profile_background_image_url_httpsBuilder = this.profile_background_image_url_https != null ? builder
			.createString(this.profile_background_image_url_https) : 0;
		int profile_image_urlBuilder = this.profile_image_url != null ? builder
			.createString(this.profile_image_url) : 0;
		int profile_link_colorBuilder = this.profile_link_color != null ? builder
			.createString(this.profile_link_color) : 0;
		int profile_sidebar_border_colorBuilder = this.profile_sidebar_border_color != null ? builder
			.createString(this.profile_sidebar_border_color) : 0;
		int profile_sidebar_fill_colorBuilder = this.profile_sidebar_fill_color != null ? builder
			.createString(this.profile_sidebar_fill_color) : 0;
		int profile_text_colorBuilder = this.profile_text_color != null ? builder
			.createString(this.profile_text_color) : 0;
